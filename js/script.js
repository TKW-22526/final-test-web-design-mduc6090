// đặt ở đầu file js/script.js
const BASE = document.currentScript.src.replace(/js\/script\.js.*$/, '');
...
function productCardHTML(p){
  return `
    <div class="card">
      <a href="${BASE}html/chi-tiet.html?id=${p.id}" class="card-link">
        <div class="card-thumb"><img src="${BASE}${p.img}" alt="${p.name}"></div> 
...
function renderProductDetail(){
  ...
  el.innerHTML = `
    <div class="detail-thumb"><img src="${BASE}${p.img}" alt="${p.name}"></div>
